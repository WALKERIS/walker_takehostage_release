...
Citizen.CreateThread(function()
	while true do 
		if takeHostage.type == "agressor" then
			...
			lib.showTextUI("Press [G] to let go, [H] to kill'") --Spausk [G] kad paleisti, [H] nuzudyti
	...
	options = {
		{
			...
			label = 'Take hostage', --Paimti zmogu ikaitu
